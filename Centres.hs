...
, ninepointcentre, ninepointcircle
, symmedianpoint
, gergonnepoint
, nagelpoint
, mittenpunkt
...
pwavg rs ps = pdiv (psum (zipWith pmult rs ps)) (sum rs)
  where psum = foldl padd porigin
        pmult r (S.Point a b) = S.Point (r*a) (r*b)
